...
export class ApiService {
  ...
  makeARequest1(url, body) {
    fetch("http://6051b8b8fb49dc00175b6997.mockapi.io/api/products", {
      method: "post",
      body: "",
  ...
  makeARequest(url, body) {
    // const newLocal = this.httpClient
    //   .get("http://localhost/abc.json")
    //   .subscribe((data) => {
    //     console.log(data);
    //   });
          ...
          product_quotes: [
            {
              ...
              product_bullet_block: [
                ...
                {
                  product_block:
                    "Save up to $480 per year in energy costs—that’s almost $5,000 over 10 years!",
                  product_bullet: "Save Money & Energy",
                },
                {
                  product_block:
                    "You can save up to $5,000 over the life of the heater with peak and off-peak energy rate scheduling with built-in demand response—letting your utility company shift the energy usage in response to the overall demand for energy at a given time",
                  product_bullet: "Demand Response Scheduling",
                },
                {
                  product_block:
                    "The ProTerra Hybrid uses 75% less energy than a standard electric water heater to help minimize your impact on the environment—that’s 4X more efficient than a standard electric water heater",
                  product_bullet: "Carbon Footprint Reduction",
                },
                {
                  product_block:
                    "The ProTerra Hybrid pulls heat energy from the air around it to heat your water, making it the most efficient water heater on the market with up to a 4.0 UEF",
                ...
                {
                  product_block:
                    "Plumbers can view detailed alerts and alarm codes while at the water heater via the Rheem Contractor App to expedite service",
            ...
            },
            {
              ...
              product_bullet_block: [
                {
                  product_block:
                    "Improved efficiency designed to ensure available hot water at the lowest possible cost with up to a 3.45 Uniform Energy Factor (UEF) rating which conserves energy and meets ENERGY STAR® qualifications",
                  product_bullet: "Increased Energy Efficiency",
                },
                {
                  product_block:
                    "Select from Efficiency, Hybrid or Electric modes to match heating requirements to environmental conditions",
                ...
                {
                  product_block:
                    "The Voltex Hybrid Electric Heat Pump Water Heater pulls environmental heat while dehumidifying and cooling the ambient air at the same time",
                  product_bullet: "Heat Pump Technology",
                },
                {
                  product_block:
                    "Long-lasting backup heating elements help heat water according to environmental conditions, demand, and the chosen operating mode",
                ...
                {
                  product_block:
                    'For complete information see the Warranty link under "More Resources"',
